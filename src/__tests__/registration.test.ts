...
describe('registerAllTools', () => {
  ...
  it('registers all expected tool names', () => {
    ...
    registerAllTools(server, createMinimalClient());
    const expectedTools = [
      'list_definitions', 'get_definition', 'search_definitions',
      'list_models', 'resolve_alias', 'validate_definition', 'render_definition',
      'create_definition', 'update_definition', 'publish_definition',
      'deprecate_definition', 'delete_definition', 'list_versions', 'diff_versions',
      'get_dependencies', 'get_dependents', 'get_execution_stats', 'list_forks',
      'fork_definition', 'check_forkable', 'get_fork_lineage', 'record_execution',
      'retranslate_definition', 'upgrade_definition', 'get_model',
      'list_providers', 'list_aliases', 'get_translator_version', 'sync_models',
      'get_user', 'batch_users',
    ];
...
describe('toolRegistry configuration', () => {
  it('has exactly 31 tool specs', () => {
    expect(toolRegistry).toHaveLength(31);
  });
